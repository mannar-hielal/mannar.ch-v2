...
((function ( $ ) {
  ...
  $.widget('aerolab.blockrain', {
    ...
    options: {
      ...
      speed: 17, // The speed of the game. The higher, the faster the pieces go.
      ...
      game._$start = $(
        '<div class="blockrain-start-holder" style="position:absolute;">'+
          '<div class="blockrain-start">'+
            ...
            '<a class="blockrain-btn btn--s blockrain-start-btn">'+ this.options.playButtonText +'</a>'+
          '</div>'+
        '</div>').hide();
      ...
      game._$gameover = $(
        '<div class="blockrain-game-over-holder" style="position:absolute;">'+
          '<div class="blockrain-game-over">'+
            ...
            '<a class="blockrain-btn btn--s blockrain-game-over-btn">'+ this.options.restartButtonText +'</a>'+
          '</div>'+
        '</div>').hide();
